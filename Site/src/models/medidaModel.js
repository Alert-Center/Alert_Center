...
function buscarUltimasMedidas(idEmpresa, idDataCenter, idRack, idSensor, limite_linhas) {
    ...
    if (process.env.AMBIENTE_PROCESSO == "producao") {
        ...
        instrucaoSql = `
        select idRack,temperatura,umidade, dtMetrica from metrica m 
        ...
        where e.idEmpresa = ${idEmpresa} and d.idDataCenter = ${idDataCenter} and r.idRack = ${idRack} and s.idSensor = ${idSensor} order by dtMetrica  limit ${limite_linhas};
        `;
    } else {
